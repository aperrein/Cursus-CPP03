...
ScavTrap::ScavTrap(void): ClapTrap(), _scav_ep(50)
{
...
ScavTrap::ScavTrap(std::string name): ClapTrap(name), _scav_ep(50)
{
...
ScavTrap::ScavTrap(ScavTrap const & copy): _scav_ep(50)
{
